 ...
 * @author Lumen
 */
@WebServlet(name = "activateCourtServlet", urlPatterns = {"/activateCourtServlet"})
public class activateCourtServlet extends HttpServlet {
	...
	HttpSession session = request.getSession();
        ...
        String sqlUpdate = "UPDATE court SET courtStat = 'active' WHERE courtID = ?"; 
